    ...
    return (
      <div style={{ minHeight: "100vh", background: "#f8f9fc", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{
            width: 44, height: 44, borderRadius: "50%", border: "3px solid #e5e7eb",
            borderTopColor: "#4f46e5", animation: "spin 0.8s linear infinite", margin: "0 auto"
          }} />
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "0 32px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: 16, fontWeight: 600, color: "#111827" }}>Bulk Candidates</h1>
        ...
        {filtered.length === 0 ? (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(310px, 1fr))", gap: 16 }}>
            {filtered.map((candidate, idx) => {
              ...
              const skills = typeof candidate.skills === "string" ? candidate.skills.split(",").map(s => s.trim()).filter(Boolean) : [];
              return (
                <div
                  key={candidate.id}
                ...
                >
                  {/* Checkbox */}
                  <div style={{ position: "absolute", top: 16, right: 16 }} onClick={e => handleSelectCandidate(candidate.id, e)}>
                    <div style={{
                      width: 20, height: 20, borderRadius: 6, border: `1.5px solid ${isSelected ? "#4f46e5" : "#d1d5db"}`,
                      background: isSelected ? "#4f46e5" : "#fff", display: "flex", alignItems: "center", justifyContent: "center",
                  ...
                  {skills.length > 0 && (
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 14 }}>
                      {skills.slice(0, 4).map((skill, i) => (
                        <span key={i} style={{ padding: "3px 9px", background: "#f0f4ff", color: "#4338ca", borderRadius: 20, fontSize: 11, fontWeight: 500 }}>
                          {skill}
                        </span>
                      ))}
                      {skills.length > 4 && (
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 12, borderTop: "1px solid #f3f4f6" }}>
                    ...
                    <button
                      ...
                      style={{ padding: "5px 8px", background: "none", border: "1px solid #fecaca", borderRadius: 6, cursor: "pointer", display: "flex", alignItems: "center", color: "#dc2626", transition: "background 0.15s" }}
