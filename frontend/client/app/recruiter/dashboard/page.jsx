      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 24, alignItems: "start" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 16 }}>
            <div style={{ backgroundColor: "#fff", border: `1.5px solid ${BORDER}`, borderRadius: 16, padding: "18px 20px" }}>
              ...
              {loading ? (
                ...
                <div key={j.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 0", borderBottom: "1px solid #F8FAFC" }}>
                  <div style={{ minWidth: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{
            ...
            <span onClick={() => router.push("/recruiter/profile")} style={{ fontSize: 12, fontWeight: 700, color: isApproved ? "#16A34A" : O, cursor: "pointer" }}>
              View Profile →
            </span>
          </div>
        </div>
