    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f8fafc" }}>
        <div style={{ textAlign: "center" }}>
          <p style={{ margin: "0 0 1rem", fontSize: "1.2rem", fontWeight: "600" }}>Applicant not found</p>
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
      ...
      <div style={{ backgroundColor: "white", padding: "1.5rem 2rem", display: "flex", alignItems: "center", gap: "1rem", boxShadow: "0 1px 3px rgba(0,0,0,0.06)", borderBottom: "1px solid #e2e8f0" }}>
        ...
        <h1 style={{ margin: 0, fontSize: "1.5rem", fontWeight: "700", color: "#0f172a" }}>Applicant Profile</h1>
      </div>
