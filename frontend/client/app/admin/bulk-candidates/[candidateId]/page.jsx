...
export default function AdminBulkCandidateDetailsPage() {
  ...
  const downloadResume = () => {
    if (!candidate?.resume_link) { showError("No resume available for this candidate"); return; }
  ...
  if (accessDenied) return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f8fafc" }}>
      <div style={{ textAlign: "center" }}>
        <p style={{ margin: "0 0 1rem", fontSize: "1.2rem", fontWeight: "600" }}>Access denied</p>
        <p style={{ margin: "0 0 1rem", color: "#64748b" }}>This page is only available to admins.</p>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "1rem", padding: "2rem", boxShadow: "0 1px 3px rgba(0,0,0,0.04)", marginBottom: "1.5rem" }}>
              <div style={{ display: "flex", gap: "1.5rem", marginBottom: "2rem", paddingBottom: "2rem", borderBottom: "2px solid #f1f5f9" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span style={{ display: "inline-block", padding: "0.4rem 0.8rem", backgroundColor: "#fef3e2", color: "#92400e", borderRadius: "0.25rem", fontSize: "0.85rem", fontWeight: "600" }}>
                    Bulk Uploaded Candidate
                  </span>
                </div>
              </div>
